...
Vous pouvez être amené à modifier une zone DNS pour :
  ...
  * prouver que vous êtes le propriétaire du domaine, par exemple, lors de l'[activation de Google Search Console](/domaines/configurer-txt-google-search-console)
