...
:::tip[Attention aux SPF générés par des IA]
Nous avons constaté que certaines IA peuvent proposer une configuration SPF incorrecte pour nos services.

**Le seul SPF à utiliser pour envoyer des e-mails depuis nos services est :**


**`include:spf.jabatus.fr`**

Toute autre valeur ou combinaison différente peut empêcher l’envoi correct de vos mails.

En cas de doute, n’hésitez pas à contactergit  notre support avant toute modification.
:::
