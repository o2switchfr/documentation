...
PHP 5.5, PHP 5.6, PHP 7, PHP 7.1, PHP 7.2, PHP 7.3, PHP 7.4, PHP 8.0, PHP 8.1, PHP 8.2, PHP 8.3, PHP 8.4, PHP8.5*
...
La version native n'évolue pas fréquemment. Le rythme de changement est de 1 fois par an ou tous les 2 ans en fonction
