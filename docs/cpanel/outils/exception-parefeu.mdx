...
Depuis le 02/05/2025, il est possible d'utiliser **deux méthodes d'authentifications** pour cette micro API : 
...
Le fonctionnement est légèrement différents en fonction de la méthode d'authentification utilisée. 
