...
Ou de serveur à serveur en SSH. La méthode de transfert de serveur à serveur est recommandé pour les emails car le
...
```bash
# En étant connecté sur l'hébergement "source"
