...
Cependant, cet outil n'est pas toujours suffisant. Vous pouvez être amené à vouloir utiliser une version précise de PHP
...
Contrairement à la version PHP native de votre panel qui tolère des permissions larges, la version PHP de votre dossier utilise **suPHP** qui refuse d'exécuter tout fichier en 777 ou 775 pour des raisons de sécurité.  
Pensez à vérifier vos permissions sur les fichiers pour éviter les erreurs.
:::
