...
# Utiliser WPCli pour gérer WordPress en ligne de commande chez o2switch
...
Il est possible de gérer les mises à jours de WordPress, des plugins et des thèmes depuis l'outil wp-cli.
